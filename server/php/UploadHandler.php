...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'accept_file_types' => '/\.(gif|jpe?g|png|zip|rar|7z|t?gz|bz2|pdf|mp3)$/i',
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
			...
			$counterFile = "size.txt";
			$totalsize = file($counterFile);
			$thisfilesize= $this->get_file_size($file_path, $append_file);
			$totalsize[0]=(int)$totalsize[0]+(int)$thisfilesize; 
			$fp = fopen($counterFile , "w");
			fputs($fp , "$totalsize[0]");
  			fclose($fp);
