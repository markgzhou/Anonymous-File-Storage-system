...
$subject = 'Your access link to manage your cloud storage'; 
...
<p>An access link from <b>Mizzou1</b> Cloud Storage.</p> 
<p>You can use the link below to check or download the file in the cloud:<br>
<a href="http://files.mizzou1.com/?sid=<?php echo($_GET['sid']);?>" target="_blank">http://files.mizzou1.com/?sid=<?php echo($_GET['sid']);?></a></p>
   <br>
